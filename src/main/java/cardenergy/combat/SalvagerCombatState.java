...
import cardenergy.patches.combat.SalvagerCombatStateFieldPatch;
...
public final class SalvagerCombatState {
    private static final int BARBED_GUARD_DAMAGE = 4;

    private SalvagerCombatState() {
    }
    ...
    public static int getExhaustedThisTurn(AbstractPlayer player) {
        return SalvagerCombatStateFieldPatch.Fields.exhaustedThisTurn.get(player);
    }

    public static boolean wasAttackedLastTurn(AbstractPlayer player) {
        return SalvagerCombatStateFieldPatch.Fields.wasAttackedLastTurn.get(player);
    }
    ...
    private static int getPendingBarbedGuard(AbstractPlayer player) {
        return SalvagerCombatStateFieldPatch.Fields.pendingBarbedGuard.get(player);
    }

    private static void setPendingBarbedGuard(AbstractPlayer player, int amount) {
        SalvagerCombatStateFieldPatch.Fields.pendingBarbedGuard.set(player, amount);
    }

    private static int getPendingTurnAside(AbstractPlayer player) {
        return SalvagerCombatStateFieldPatch.Fields.pendingTurnAside.get(player);
    }

    private static void setPendingTurnAside(AbstractPlayer player, int amount) {
        SalvagerCombatStateFieldPatch.Fields.pendingTurnAside.set(player, amount);
    }

    private static boolean isTurnAsideSafe(AbstractPlayer player) {
        return SalvagerCombatStateFieldPatch.Fields.turnAsideSafe.get(player);
    }

    private static void setTurnAsideSafe(AbstractPlayer player, boolean value) {
        SalvagerCombatStateFieldPatch.Fields.turnAsideSafe.set(player, value);
    }

    private static boolean wasAttackedSinceLastTurn(AbstractPlayer player) {
        return SalvagerCombatStateFieldPatch.Fields.wasAttackedSinceLastTurn.get(player);
    }

    private static void setWasAttackedSinceLastTurn(AbstractPlayer player, boolean value) {
        SalvagerCombatStateFieldPatch.Fields.wasAttackedSinceLastTurn.set(player, value);
    }

    private static void setWasAttackedLastTurn(AbstractPlayer player, boolean value) {
        SalvagerCombatStateFieldPatch.Fields.wasAttackedLastTurn.set(player, value);
    }

    private static void setExhaustedThisTurn(AbstractPlayer player, int amount) {
        SalvagerCombatStateFieldPatch.Fields.exhaustedThisTurn.set(player, amount);
    }
}
